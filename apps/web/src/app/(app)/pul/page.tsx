    ...
    <div className="grid gap-6">
      <section className="flex flex-wrap items-end justify-between gap-3">
        ...
        <div className="flex flex-wrap gap-2">
          {canWrite && (
            <>
              <TransactionSheet direction="in" accounts={open} categories={data.categories} today={today} />
              <TransactionSheet direction="out" accounts={open} categories={data.categories} today={today} />
